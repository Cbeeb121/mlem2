require './lib/daru/accessors/dataframe_by_row.rb'
require './lib/daru/maths/arithmetic/dataframe.rb'
require './lib/daru/maths/statistics/dataframe.rb'
require './lib/daru/plotting/gruff.rb'
require './lib/daru/plotting/nyaplot.rb'
require './lib/daru/io/io.rb'
